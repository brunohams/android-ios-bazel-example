...
_SETTINGS = {
  "arm64-apple-ios14.0.0-simulator iostests.xctest/iostests" : {
    "clang" : "-iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/ios-sim_arm64-min14.0-applebin_ios-ios_sim_arm64-dbg-ST-e8cf74a10fda/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/ios-sim_arm64-min14.0-applebin_ios-ios_sim_arm64-dbg-ST-e8cf74a10fda/bin\" -O0 -fstack-protector -fstack-protector-all",
    "frameworks" : [
    ...
    "includes" : [
      ...
      "$(BAZEL_OUT)/ios-sim_arm64-min14.0-applebin_ios-ios_sim_arm64-dbg-ST-e8cf74a10fda/bin/Bullseye-iOS"
    ]
  },
  "arm64-apple-ios14.0.0-simulator myfirstapp.app/myfirstapp" : {
    "clang" : "-iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/ios-sim_arm64-min14.0-applebin_ios-ios_sim_arm64-dbg-ST-e8cf74a10fda/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all",
    "frameworks" : [
